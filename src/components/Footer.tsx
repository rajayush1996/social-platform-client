...
const Footer = () => {
  return (
    <footer className="bg-black/40 border-t border-border pt-12 pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/reels" className="text-sm text-foreground/70 hover:text-foreground transition-colors">Reels</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/cookies" className="text-sm text-foreground/70 hover:text-foreground transition-colors">Cookies Policy</Link>
              </li>
            </ul>
          </div>
