export const API_CONFIG = {
  ...
  ENDPOINTS: {
    ...
    MEDIA: {
      ...
      INCREMENT_VIEW: (id: string) => `/user/media-metadata/${id}/view`,
      LIKE: (id: string) => `/user/media-metadata/${id}/like`,
      UNLIKE: (id: string) => `/user/media-metadata/${id}/unlike`,
      COMMENT: (id: string) => `/user/media-metadata/${id}/comments`,
      COMMENTS: (id: string) => `/user/media-metadata/${id}/comments`,
      DELETE_COMMENT: (id: string, commentId: string) => `/user/media-metadata/${id}/comments/${commentId}`,
      SHARE: (id: string) => `/user/media-metadata/${id}/share`,
      USER_MEDIA: '/user/media-metadata/user',
      LIKED_MEDIA: '/user/media-metadata/liked',
      CATEGORIES: '/user/media-metadata/categories',
    },
    REELS: {
